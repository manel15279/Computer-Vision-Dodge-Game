...
generate_button6 = ctk.CTkButton(input_frame2, text="Erode/Dilate", command=lambda: button_function_6('xford.jpg'))
generate_button6.grid(row=8, column=0, columnspan=2, sticky="news", padx=10, pady=10)
generate_button7 = ctk.CTkButton(input_frame2, text="Closing/Opening", command=lambda: button_function_7('xford.jpg'))
